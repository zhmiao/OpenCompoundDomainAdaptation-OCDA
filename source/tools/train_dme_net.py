...
def train_dme_multi(src, tgt, base_model, num_cls, tgt_list, num_epoch=200,
                    batch=128, datadir="", outdir="",
                    src_weights=None, lr=1e-5, betas=(0.9, 0.999),
                    weight_decay=0, centroids_path=None, feat_dim=512):
